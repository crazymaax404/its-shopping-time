...
export type PurchaseStackParamList = {
  ...
  FinishPurchase: { sessionId: string; totalAmount: number; purchasedItemIds: string[] };
};
...
export const PurchaseStack = createNativeStackNavigator<PurchaseStackParamList>();
